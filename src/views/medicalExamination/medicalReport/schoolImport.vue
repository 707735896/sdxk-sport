<template>
    <div class="content-box user-import">
        <div class="title">县市学校体检数据批量导入</div>
        <a :href="student_import" download="体检结果导入模板.xlsx" class="add"
        ...
        <div class="form-main">
                ...
                <Form ref="obj" :model="req" :rules="rules" inline label-position="left">
                    <div class="rows">
                        <FormItem label="区域" :label-width="100" style="margin-right: 0 !important;" prop="p_area">
                            <i-select v-model="req.p_area" style="width:146px;" @on-change="areaChange">
                        ...
                        <FormItem label="医疗机构" :label-width='100' style="margin-left: 60px;" prop="hos_dep">
                            <i-select v-model="req.hos_dep" style="width:304px" :disabled="!is_manage">
                                <!--<i-option value="-1">全部</i-option>-->
                    ...
                    <div class="rows">
                        ...
                        <!--</i-select>-->
                        <!--</FormItem>-->
                        <FormItem label="体检学年" :label-width='100' prop="med_year">
                        ...
                        <FormItem label="学校名称" :label-width='100' style="margin-left: 60px;" prop="school_id">
                            <i-select style="width:300px" filterable v-model="req.school_id">
                                <!--<i-option value="-1">全部</i-option>-->
                    ...
                    <div class="rows">
                        ...
                        <FormItem label="体检类型" :label-width='100' prop="med_type">
                    ...
                    <div>
                        ...
                        <FormItem label="选择文件" :label-width='100'>
                            ...
                            <span slot="label"><span
                                style="display:inline-block;width:10px;color: red;">*</span>选择文件</span>
            ...
            <Button type="primary" class="search-btn" @click="search" style="float: right;margin-right: 40px;">导入
            </Button>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    med_year: [{required: true, message: '请选择体检学年', trigger: 'change'}]
        ...
        methods: {
            ...
            search() {
                this.$refs['obj'].validate(value => {
                    ...
                    form.append('med_year', this.req.med_year);
                    form.append('uploadFile', this.tempFile);
                    // if (file.tempFile[0].size / 1024 / 1024 > 1) {
                    //     this.$Spin.show();
                    // }
                    this.$Spin.show();
                    axios.post(urls.baseApi + urls.user_data_import, form, {
                        ...
                        if (data.code === 500) {
                            ...
                            for (let i = 0; i < data.list.length; i++) {
                                str += '<span style="float:right">' + data.list[i] + '<span><br>';
                            }
        ...
        created() {
            if (sessionStorage.getItem('roleCode') !== '999') {
                ...
                this.req.hos_dep = sessionStorage.getItem('dep_id');
            }
