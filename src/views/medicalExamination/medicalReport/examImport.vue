        ...
        <div class="form-main">
            <Form ref="obj" :model="req" inline label-position="left">
                ...
                <div class="rows">
                    ...
                    <FormItem label="体检时间" :label-width="100" style="margin-left: 60px;" prop="term">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                ...
                try {
                    axios({
                        method: 'get',
                        url: urls.user_data_export,
                        params: data
                    }).then(res => {
                        if (res.data.code == 200) {
                            window.location.href = urls.user_data_export + "?" + qs.stringify(data)
        ...
        created() {
            ...
            if (rolecode !== '999'&&rolecode !== '10204001' &&rolecode !== '10204002') {
