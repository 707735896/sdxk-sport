        ...
        >
            <Form inline ref="obj" :model="obj" label-position="top" class="modal-form">
                ...
                <i-input type="textarea" v-model.trim="disease.other_unwell" :disabled="flag"
                         style="margin-left: 20px;width: 700px"></i-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            search() {
                // 这是为了防止详情数据返回而学校列表还没值的情况
                Promise.all([this.$ajax({url: urls.dept_all_list,data:{}}), getFitStudentList(this.id)]).then(value => {
