<template>
    <div>
        ...
        >
            <Form inline :model="obj" ref="obj" class="modal-form" label-position="top">
                <FormItem label="体检学年" prop="year">
                    <i-select style="width:310px" v-model="obj.year" disabled>
                ...
                <FormItem label="体检医院" prop="dep_id">
                    <i-select style="width:310px" filterable v-model="obj.dep_id" disabled>
            ...
            <BaseTable :columns="columns" :data="tableData" height="300" :modalFlag="true"></BaseTable>
            <div slot="footer">
        ...
        <Modal
                ...
                @on-cancel="addclose"
        >
            <Form inline ref="plan_info_form" :model="planInfo" label-position="top" :rules="rules">
                ...
                <FormItem label="体检时间" prop="time">
                    <DatePicker type="datetimerange" format="yyyy-MM-dd HH:mm"
                                v-model="planInfo.time" style="width: 440px">
                    </DatePicker>
                </FormItem>
                <FormItem label="" style="width: 0;">
...
<script>
    ...
    import {stringFromnDate} from '@/libs/dateUtils';
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            if (params.row.exam_start_long && params.row.exam_end_long) {
                                return h('span', null, stringFromnDate(params.row.exam_start_long) + '-' + stringFromnDate(params.row.exam_end_long));
                            } else {
                                return '';
                            }
                        }
        ...
        methods: {
            ...
            addconfirms() {
                this.$refs['plan_info_form'].validate(valid => {
                    ...
                    if(this.planInfo.time[0].getTime()>=this.planInfo.time[1].getTime()){
                    ...
                    if(this.flag === 3){ // 更新时间
                        this.$ajax({
                            ...
                            if(json.code === 200){
                                this.$Message.success('排程时间更新成功');
                                this.tableData.splice(this.index, 1, data);
                                this.addclose();
                            }else {
                                this.$Message.error('排程时间更新失败');
                            }
                        })
                    }else {
                        this.$ajax({
