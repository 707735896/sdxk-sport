        ...
        >
            <Form inline ref="obj" :model="obj" :rules="rules" label-position="top">
                ...
                <FormItem label="医疗机构名称" style="margin-right: 0 !important;" prop="dep_id">
                    <i-select v-model="obj.dep_id" filterable style="width:310px" :disabled="flag">
                        <Option v-for="item in hospitalList" :value="item.id" :key="item.id">{{item.name}}</Option>
                    </i-select>
                </FormItem>
                <FormItem label="体检学年" prop="year">
                    <i-select style="width:310px" v-model="obj.year" :disabled="flag">
            ...
            <BaseTable :columns="columns" :data="tableData" height="300"
                   style="margin-bottom: 10px;" :modalFlag="true"></BaseTable>
            <div slot="footer">
            ...
            return {
                ...
                rules: {
                    ...
                    code: [
                        ...
                        {pattern: /^[0-9]{6}$/, message: '体检计划代号6位数字', trigger: 'blur'}
                    ]
                },
                tableData: [],
                hospitalList: [],
            ...
            ModalClose(data) {
                if (data) {
                    for (var i = 0, len = this.tableData.length; i < len; i++) {
                        if (this.tableData[i].check_class_id === data.check_class_id) {
