                        ...
                        <div class="con">
                            <Form ref="obj" :model="obj" :rules="rules" inline label-position="top">
                                <FormItem label="账号" prop="school_id">
                                    <i-input v-model.trim="obj.school_id" style="width:300px"></i-input>
                                </FormItem>
                                <FormItem label="密码" prop="password">
                                    <i-input type="password" v-model.trim="obj.password" style="width:300px"></i-input>
                                </FormItem>
                                <FormItem label="导入路径" prop="semester">
                                    <i-input v-model.trim="obj.semester" style="width:300px"></i-input>
                                </FormItem>
                                <FormItem label="导入文件" prop="grade_id">
                                    <i-input v-model.trim="obj.grade_id" style="width:300px"></i-input>
                                </FormItem>
