        ...
        >
            <Form ref="obj" :model="obj" :rules="rules" inline label-position="left">
                <FormItem label="医生姓名" prop="name" style="margin-left: 66px">
                    <i-input v-model.trim="obj.name" :maxlength="20" style="width: 200px" placeholder="请输入"></i-input>
                </FormItem>
                <FormItem label="所属医疗机构" prop="dep_id">
                    <i-select v-model="obj.dep_id" filterable style="width:200px" @on-change="hospitalChange" :disabled="!is_manage">
                ...
                <!--<FormItem label="所属科室" prop="hospital_dep_id" style="margin-left: 66px">-->
                    ...
                    <!--</i-select>-->
                <!--</FormItem>-->
                <FormItem label="体检项" prop="set_id" style="margin-left: 66px">
                    <i-select v-model="obj.set_id" style="width:200px">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    set_id: [{required: true, message: '请选择体检项', trigger: 'change'}]
                },
                sectionList: [],
                hospitalList: [],
                itemList: [],
