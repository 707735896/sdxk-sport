    ...
    <div class="medical content-box">
        ...
        <Form inline label-position="left" class="search-form">
            <FormItem label="医疗机构执业许可证" :label-width="150">
                <i-input v-model.trim="req.licence" :maxlength="30" style="width: 200px"></i-input>
            </FormItem>
            <FormItem label="医疗机构名称" :label-width="110">
                <i-input v-model.trim="req.name" :maxlength="30" style="width: 200px"></i-input>
            </FormItem>
            <div class="operator">
        ...
        <div>
            <a href="javascript:void(0)" class="add" @click="add">
                <img src="../../../assets/common/add.png" alt="add">&nbsp;新增
            </a>
        </div>
        <BaseTable
                center
