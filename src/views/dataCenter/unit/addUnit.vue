    ...
    <div>
        ...
        >
            <Form ref="obj" :model="obj" :rules="rules" inline label-position="top">
                <FormItem label="医疗机构执业许可证(登记号)" prop="licence" style="margin-left: 26px">
                    <i-input v-model.trim="obj.licence" :maxlength="30" style="width: 240px" placeholder="请输入"></i-input>
                </FormItem>
                 <FormItem label="医疗机构名称" prop="name">
                    <i-input v-model.trim="obj.name" :maxlength="30" style="width: 260px" placeholder="请输入"></i-input>
                </FormItem>
                <FormItem label="性质" prop="nature" style="margin-left: 26px">
                    <i-select v-model="obj.nature" style="width:240px">
                ...
                <FormItem label="所在区域" prop="area_id1">
                    ...
                    <div>
                        ...
                        <i-select v-model="obj.area_id2" style="width:146px;">
                            <i-option v-for="item of areaList" :key="item.id" :value='item.id'>{{item.name}}</i-option>
                        </i-select>
                    </div>

                </FormItem>
                <FormItem label="详细地址" prop="location" style="margin-left: 26px">
                    <i-input v-model.trim="obj.location" :maxlength="30" style="width: 544px" placeholder="请输入"></i-input>
                </FormItem>
            </Form>
            <div slot="footer">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    licence: [{required: true, message: '请输入医疗机构执业许可证(登记号)', trigger: 'blur'},
                        {pattern: /^[0-9]{1,30}$/, message: '医疗机构执业许可证(登记号)为数值类型', trigger: 'blur'}],
