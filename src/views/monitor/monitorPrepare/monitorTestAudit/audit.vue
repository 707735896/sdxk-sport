        ...
        >
            <div class="edit clearfix">
                <Form ref="obj" :model="obj" inline label-position="top">
                    <FormItem label="监测年份" prop="year" style="width: 300px;margin-right: 90px!important">
                        <i-input v-model="obj.year" :maxlength="19" :disabled="true"></i-input>
                    </FormItem>
                    <FormItem label="监测计划代号" prop="code" style="width: 300px;margin-right: 0!important">
                        <i-input v-model="obj.code" :disabled="true"></i-input>
                    </FormItem>
                </Form>
            </div>
            ...
            <div class="reason" v-if="disabled" v-show="info===1 && auditGroup === '驳回' || auditMsg === '已驳回'">
                 <!-- <Form ref="reason" :rules="rules" label-position="top">
                    <FormItem label="驳回理由" prop="reason">
