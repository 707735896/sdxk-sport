<template>
    <div class="content-box fitTemplate">
        <div class="title">上报体检数据模板设定</div>
        <Form v-model="req" inline :label-width="50">
            ...
            <FormItem label="学校名称" :label-width="80">
                <i-select style="width:200px" v-model="req.dep_id" filterable @on-change="schoolChange"
                          :disabled="!is_manage">
