<template>
    <div id="index" style="height: 100%">
        ...
        <div class="menu-container">
            <div class="system">
                <div class="hover" @mouseleave="switchImgs(1)" @mouseenter="switchImg(1)" @click="goto('system')"
                     style="position: absolute;width: 100%;height: 100%;transform: rotate(-55deg) rotateX(43deg) rotateY(32deg) translate(1px,22px);"></div>
            ...
            <div class="dataCenter">
                <div class="hover" @mouseleave="switchImgs(2)" @mouseenter="switchImg(2)" @click="goto('dataCenter')"
                     style="position: absolute;width: 100%;height: 100%;transform:rotate(-58deg) rotateX(22deg) rotateY(53deg) translate(-24px,21px);"></div>
            ...
            <div class="monitor">
                <div class="hover" @mouseleave="switchImgs(3)" @mouseenter="switchImg(3)" @click="goto('monitor')"
                     style="position: absolute;width: 70%;height: 100%;transform: rotate(-57deg) rotateX(57deg) rotateY(29deg) translate(-65px, 94px);"></div>
            ...
            <div class="health_review">
                <div class="hover" @mouseleave="switchImgs(4)" @mouseenter="switchImg(4)"
                     @click="goto('medicalExamination')"
                     style="position: absolute;width: 100%;height: 100%;transform: rotate(-57deg) rotateX(44deg) rotateY(34deg) translate(-4px, 40px);"></div>
            ...
            <div class="health_test">
                <div class="hover" @mouseleave="switchImgs(5)" @mouseenter="switchImg(5)"
                     @click="goto('physicalFitnessTest')"
                     style="position: absolute;width: 100%;height: 100%;transform:rotate(55deg) rotateX(-29deg) rotateY(40deg) translate(12px, -10px);"></div>
